...
class movie{
   ...
   let Movie1=new movie("Singam","2dproduction")
   Movie1.display()
  let Movie2=new movie("Bahubhali","xxxx","PG")
  let Movie3=new movie("Gilli","SGM","PG")
...
let Person1=new Person("Kanimozhi","4.4","45","30","Asian","B.sc","Computer Science","Tamilnadu")
Person1.details()
...
class Circle{
    ...
    getArea(){
        let area=parseInt(3.14*this.getRadius()*this.getRadius()).toFixed(2)
        return `"Area of circle is" ${area}`
    }
   getCircumference(){
       let circum=parseInt(2*3.14*this.getRadius()).toFixed(2)
